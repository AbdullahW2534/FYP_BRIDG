...
//                 <Navbar backgroundImage="bg-[url('./bg4.jpg')]" />
//                 <Heading />
//                 <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 py-10 justify-center'>
...
//                             <h2 className='w-full text-start text-xs mt-1'><span className='font-bold'>Sizes :</span> {product.productSizes}</h2>
//                             <h2 className='w-full text-start text-xs mt-1'><span className='font-bold'>Colors : </span>{product.productColors}</h2>

//                             <div className='w-full flex items-center justify-between p-2'>
//                                 <h2 className='text-end font-bold text-5xl text-yellow-500'>{product.productPrice}<span className='font-light text-sm text-black'> USD /- </span></h2>
